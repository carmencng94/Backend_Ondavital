...
const staticTranslations = {
  es: {
    ...
    booking_email_ph: 'Correo electrónico',
    booking_phone_ph: 'Teléfono / WhatsApp',
    booking_activity_ph: '¿Qué actividad realizarás? (ej. Yoga, Terapia, Taller)',
    booking_ruidosa_label: 'Si consideras que tu actividad es ruidosa (música, sonido elevado, etc.), por favor selecciona esta casilla. Respetemos el silencio y las demás actividades del centro.',
    booking_receipt_title: 'Resumen de tu Pre-Reserva',
    booking_receipt_room: 'Sala:',
    booking_receipt_date: 'Fecha:',
    booking_receipt_time: 'Horario:',
    booking_receipt_price: 'Precio Estimado:',
    booking_receipt_deposit: '⚠️ Depósito del 50% requerido',
    booking_receipt_deposit_desc: 'Se requiere un depósito de {deposit}€ para confirmar la reserva.',
    // --- ABOUT & CONTACT ---
  ...
  en: {
    ...
    booking_email_ph: 'Email address',
    booking_phone_ph: 'Phone / WhatsApp',
    booking_activity_ph: 'What activity will you do? (e.g. Yoga, Therapy, Workshop)',
    booking_ruidosa_label: 'If you consider that your activity is noisy (music, high sound, etc.), please select this checkbox. Let\'s respect silence and the other activities of the center.',
    booking_receipt_title: 'Pre-Booking Summary',
    booking_receipt_room: 'Room:',
    booking_receipt_date: 'Date:',
    booking_receipt_time: 'Time slots:',
    booking_receipt_price: 'Estimated Price:',
    booking_receipt_deposit: '⚠️ 50% Deposit required',
    booking_receipt_deposit_desc: 'A deposit of {deposit}€ is required to confirm the booking.',
    // --- ABOUT & CONTACT ---
  ...
  de: {
    ...
    booking_email_ph: 'E-Mail-Adresse',
    booking_phone_ph: 'Telefon / WhatsApp',
    booking_activity_ph: 'Welche Aktivität werden Sie durchführen? (z.B. Yoga, Therapie, Workshop)',
    booking_ruidosa_label: 'Wenn Sie der Meinung sind, dass Ihre Aktivität laut ist (Musik, hohe Lautstärke usw.), aktivieren Sie bitte dieses Kontrollkästchen. Bitte respektieren Sie die Stille und die anderen Aktivitäten des Zentrums.',
    booking_receipt_title: 'Vorbuchungsübersicht',
    booking_receipt_room: 'Raum:',
    booking_receipt_date: 'Datum:',
    booking_receipt_time: 'Uhrzeit:',
    booking_receipt_price: 'Geschätzter Preis:',
    booking_receipt_deposit: '⚠️ 50% Anzahlung erforderlich',
    booking_receipt_deposit_desc: 'Eine Anzahlung von {deposit}€ ist erforderlich, um die Buchung zu bestätigen.',
    // --- ABOUT & CONTACT ---
  ...
  ca: {
    ...
    booking_email_ph: 'Correu electrònic',
    booking_phone_ph: 'Telèfon / WhatsApp',
    booking_activity_ph: 'Quina activitat realitzaràs? (ex. Ioga, Teràpia, Taller)',
    booking_ruidosa_label: 'Si consideres que la teva activitat és sorollosa (música, so elevat, etc.), si us plau selecciona aquesta casella. Respectem el silenci i les altres activitats del centre.',
    booking_receipt_title: 'Resum de la teva Pre-Reserva',
    booking_receipt_room: 'Sala:',
    booking_receipt_date: 'Data:',
    booking_receipt_time: 'Horari:',
    booking_receipt_price: 'Preu Estimat:',
    booking_receipt_deposit: '⚠️ Dipòsit del 50% requerit',
    booking_receipt_deposit_desc: 'Es requereix un dipòsit de {deposit}€ per confirmar la reserva.',
    // --- ABOUT & CONTACT ---
